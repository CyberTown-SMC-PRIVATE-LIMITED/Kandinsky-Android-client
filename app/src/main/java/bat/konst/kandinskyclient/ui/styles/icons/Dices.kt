    ...
    get() {
        ...
        _Dices = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2.24f, 2.24f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -3f)
                lineToRelative(-5f, -4.92f)
                arcToRelative(2.24f, 2.24f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3f, 0f)
                lineTo(10f, 6f)
            }
            path(
                fill = null,
