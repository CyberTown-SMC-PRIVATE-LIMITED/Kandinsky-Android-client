...
class generateImages @Inject constructor(
    ...
    private suspend fun checkGeneratedImages(): Boolean {
        /*
    ...
    private suspend fun sendImageToGenerate() {
        ...
        */
        ...
        val imageResult =
            kandinskyApiRepository.getRequesrtStatusOrImage(key, secret, image.kandinskyId)
